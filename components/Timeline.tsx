...
const events: TimelineEvent[] = [
  ...
  },
  {
    ...
    description: `В момента селото е с ограничен брой жители, но все още има пенсионерски клуб, както и активна фолклорна група "Детелина", често участващи в представления в региона.`,
    imageUrl:
